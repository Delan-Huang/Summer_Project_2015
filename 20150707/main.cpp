...
static PyObject* test(PyObject* self, PyObject* args) {
	...
	// Side 1- No rotation.
	createProjection(project1, rotate1, in, xDim, yDim, zDim);
	// Side 2- 180 degrees along Z
	createProjection(project2, rotate2, in, xDim, yDim, zDim);
	// Side 3- 90 degrees along Z
	createProjection(project3, rotate3, in, xDim, yDim, zDim);
	// Side 4- 270 degrees along Z
	createProjection(project4, rotate4, in, xDim, yDim, zDim);
	// Top- 90 degrees along Y
	createProjection(project5, rotate5, in, xDim, yDim, zDim);
	// Bottom- 270 degrees along Y
// IS NOT CORRECT!
	createProjection(project6, rotate6, in, xDim, yDim, zDim);	
	...
	pReturn = Py_BuildValue("(O,O,O,O,O,O,i,i,i)", p1, p2, p4, p3, p5, p6, xDim, yDim, zDim);
	...
	myStack.setup(xDim, yDim, 1, 1.0, 1.0,1.0, project6);
	myStack.output(IMG_NAME_OUT);
