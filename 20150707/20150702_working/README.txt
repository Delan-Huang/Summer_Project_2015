...
Parameters:
    ...
    args: This is a single tuple containing 6 lists (list1, list2 ...) 
    and 3 integers (xDim, yDim, zDim).It gets passed into MainWindow by 
    a C++ extension.

Description:

    Creates and sets the main layout for the GUI, and includes signal/slots
    to allow widgets to 'communicate' with one another
...
Associated Functions:
    ...
    Parameters:
        ...
        args is (list1, list2, list3, list4, list5, list6, xDim, yDim, zDim).
