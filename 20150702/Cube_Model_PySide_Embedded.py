...
def main(argv):
    loc = "C:\Summer_Project_2015/20150701\Cube_Model_PySide_Embedded.py"
    # cd = subprocess.call("cd " + loc, shell=True)
    return_code = subprocess.call("python Cube_Model_PySide.py -l1 1 -l2 2 -l3 3 -l4 4 -l5 5 -l6 6 -xDim 1 -yDim 1 -zDim 1", shell=True)
